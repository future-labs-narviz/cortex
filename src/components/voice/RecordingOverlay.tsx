  ...
  return (
    <div role="status" aria-live="polite" className="recording-overlay fixed inset-0 z-50 bg-black/60 flex items-center gap-4 px-4 py-2 shrink-0" style={{ WebkitBackdropFilter: 'blur(8px)', backdropFilter: 'blur(8px)' }}>
      ...
      <button
        ...
        className="flex items-center justify-center w-6 h-6 rounded-[var(--radius-lg)] bg-[var(--muted)] border border-[var(--border)] hover:bg-[var(--muted-hover)] text-[var(--text-muted)] hover:text-[var(--red)] transition-colors duration-150 ease cursor-pointer focus:outline-none focus:ring-2 focus:ring-[var(--accent)] focus:ring-offset-2 focus:ring-offset-[var(--bg-primary)]"
