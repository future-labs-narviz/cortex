  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="flex items-center justify-between w-full gap-2 px-3 py-2 text-sm rounded-md bg-[var(--bg-tertiary)] border border-[var(--border)] text-[var(--text-primary)] hover:bg-[var(--border)] transition-colors cursor-pointer"
      >
      ...
      {/* Dropdown */}
      {isOpen && (
        <div className="absolute z-50 mt-1 w-full min-w-[300px] rounded-md bg-[var(--bg-secondary)] border border-[var(--border)] shadow-lg overflow-hidden">
            ...
            return (
              <div
                ...
                className={`flex items-start gap-3 px-3 py-2.5 transition-colors ${
                  isDownloaded ? "cursor-pointer hover:bg-[var(--bg-tertiary)]" : ""
                ...
                <div className="shrink-0 mt-0.5">
                  {status?.status === "downloaded" ? (
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 px-2 py-0.5 rounded text-[10px] bg-[var(--accent-soft)] text-[var(--accent)] hover:bg-[var(--accent)]/25 transition-colors cursor-pointer"
                    >
                      <Download size={10} />
                      Download
                    </button>
